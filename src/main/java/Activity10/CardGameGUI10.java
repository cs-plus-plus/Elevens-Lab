 ...
 */
public class CardGameGUI10 extends JFrame implements ActionListener {
	 ...
	 */
	public CardGameGUI10(Board10 gameBoard) {
		board = gameBoard;
		totalWins = 0;
		totalGames = 0;
	 ...
	 */
	private String imageFileName(Card10 c, boolean isSelected) {
		String str = "cards/";
		if (c == null) {
